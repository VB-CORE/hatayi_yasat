...
import 'package:vbaseproject/features/v2/sub_feature/forms/view/scholarship_request_form.dart';
  ...
  void initState() {
    ...
    ref.listenManual(_homeProvider, (previous, next) async {
      ...
      if (!next.isOperationStaring) {
        ProjectNavigation(context)
            .replaceToWidget(const ScholarshipRequestForm());
      }
    });
  }
}
