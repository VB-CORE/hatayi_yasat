...
part 'widget/discussion_header_title.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: _DiscussionHeaderTitle(args: args),
        actions: [
          Padding(
            padding: const PagePadding.onlyRight(),
            child: GeneralStatusBadge(
              label: args.discussion.entryCount.toString(),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: CustomFirestoreListView<GroupDiscussionEntryModel>(
                  query: ref.read(entriesNotifier.notifier).entries,
