...
@immutable
final class DeleteGroupConfirmSheet extends StatelessWidget {
  const DeleteGroupConfirmSheet._();
  ...
  static Future<bool?> show(BuildContext context) {
    return showModalBottomSheet<bool>(
      ...
      builder: (context) => const DeleteGroupConfirmSheet._(),
    );
  }
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: GeneralContentTitle(
                    value: LocaleKeys
                        .community_groupDetail_details_deleteGroupConfirmTitle
                        .tr(),
            ...
            GeneralContentSubTitle(
              value: LocaleKeys
                  .community_groupDetail_details_deleteGroupConfirmMessage
                  .tr(),
            ...
            GeneralButtonV2.async(
              ...
              label: LocaleKeys.community_groupDetail_details_deleteGroup.tr(),
              icon: AppIcons.delete,
            ),
            ...
            Center(
              child: TextButton(
                ...
                child: Text(
                  LocaleKeys
                      .community_groupDetail_details_deleteGroupConfirmCancel
                      .tr(),
                ),
              ),
            ),
