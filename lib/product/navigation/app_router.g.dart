        ...
        GoRouteData.$route(
          ...
          routes: [
            GoRouteData.$route(
              ...
              hasOverriddenOnExit: false,
              factory: $DevelopersVeteransRoute._fromState,
            ),
          ],
        ),
        GoRouteData.$route(
...
mixin $_MerchantPanelRoute on GoRouteData {
  static _MerchantPanelRoute _fromState(GoRouterState state) =>
      const _MerchantPanelRoute();

  @override
  String get location => GoRouteData.$location('/main/merchantPanel');
...
mixin $_MerchantPendingRoute on GoRouteData {
  static _MerchantPendingRoute _fromState(GoRouterState state) =>
      const _MerchantPendingRoute();

  @override
  String get location => GoRouteData.$location('/main/merchantPending');
...
mixin $_MerchantApplicationRoute on GoRouteData {
  static _MerchantApplicationRoute _fromState(GoRouterState state) =>
      const _MerchantApplicationRoute();

  @override
  String get location => GoRouteData.$location('/main/merchantApplication');
...
mixin $DevelopersVeteransRoute on GoRouteData {
  static DevelopersVeteransRoute _fromState(GoRouterState state) =>
      const DevelopersVeteransRoute();

  @override
  String get location =>
      GoRouteData.$location('/main/settings/developers/veterans');
