...
final class MemoryEmptyModel {
  ...
  static List<MemoryModel> mockMemories = [
    MemoryModel(
      ...
      imageUrl: const ['https://picsum.photos/400/400?random=1'],
    ...
    MemoryModel(
      ...
      imageUrl: const ['https://picsum.photos/400/400?random=2'],
    ...
    MemoryModel(
      ...
      imageUrl: const ['https://picsum.photos/400/400?random=3'],
    ...
    MemoryModel(
      ...
      imageUrl: const ['https://picsum.photos/400/400?random=4'],
    ...
    MemoryModel(
      ...
      imageUrl: const ['https://picsum.photos/400/400?random=5'],
    ...
    MemoryModel(
      ...
      imageUrl: const ['https://picsum.photos/400/400?random=6'],
    ...
    MemoryModel(
      ...
      imageUrl: const ['https://picsum.photos/400/400?random=7'],
    ...
    MemoryModel(
      ...
      imageUrl: const ['https://picsum.photos/400/400?random=8'],
    ...
    MemoryModel(
      ...
      imageUrl: const ['https://picsum.photos/400/400?random=9'],
